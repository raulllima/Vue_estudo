    ...
    <div class="content">
      ...
      >
        ...
        <template #empty-message>
          <span style="font-size: 14px; color: #C2cad4">
...
export default {
  ...
  setup() {
    ...
    const btnDeleteItem = (itemObj, key) => {
      ...
      api.delete(`/${currentTable}/C2/deleteItem/` + itemObj.id).then(() => {
        if (key === 1) {
    ...
    const btnEditItem = (itemObj, key) => {
      ...
      if (endpointRoute === "editItem") {
        if (!itemObj.isReadonly && !diffJson) {
          api
            .put(`/${currentTable}/C2/` + endpointRoute, {
              data: itemObj,
            })
            .then(() => {
              notify({
        ...
        if (!itemObj.isReadonly) {
          api
            .post(`/${currentTable}/C2/` + endpointRoute, {
              data: itemObj,
            })
            .then(() => {
              notify({
