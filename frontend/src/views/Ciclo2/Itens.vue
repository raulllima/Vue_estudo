          ...
          <template #item-produto="item">
            ...
            >
              <input
                ...
                :value="item.produto"
                @copy.prevent
                @input="(e) => updateItem(item, 'produto', e.target.value)"
              />
              <div class="underline"></div>
            </div>
          </template>

          <template #item-cod_produto="item">
            <div
              class="input-container"
              @keydown.enter="btnEditItem(item)"
              @keydown.esc="disableEdit(item)"
            ...
            >
              <input
                ...
                @copy.prevent
                @input="(e) => updateItem(item, 'cod_produto', e.target.value)"
              />
              <div class="underline"></div>
            </div>
          </template>
          ...
          <template #item-peso_total="item">
            ...
            >
              <input
                ...
                @copy.prevent
                @input="(e) => updateItem(item, 'peso_total', e.target.value)"
              />
              <div class="underline"></div>
            </div>
          </template>
          ...
          <template #item-valor_total="item">
            ...
            >
              <input
                ...
                @copy.prevent
                @input="(e) => updateItem(item, 'valor_total', e.target.value)"
              />
              <div class="underline"></div>
            </div>
          </template>

          <template #item-demanda_mensal_prod="item">
            <div
              class="input-container"
              @keydown.enter="btnEditItem(item)"
              @keydown.esc="disableEdit(item)"
            ...
            >
              <input
                ...
                type="text"
                :readonly="item.isReadonly"
                :value="item.demanda_mensal_prod"
                @copy.prevent
                @input="(e) => updateItem(item, 'demanda_mensal_prod', e.target.value)"
              />
              <div class="underline"></div>
            </div>
          </template>
...
export default {
  ...
  setup() {
    ...
    const btnDeleteItem = (val) => {
      api.delete("/itens/C2/deleteItem/" + val.id).then(() => {
