...
export default {
  ...
  setup() {
    ...
    const produto = ref("");
    const codProduto = ref("");
    const pesoTotal = ref("");
    const valorTotal = ref("");
    const demandaMensalProd = ref("");
    const codItem = ref("");
    const descricao = ref("");
    const material = ref("");
    ...
    const updateItemData = () => {
      requestBody.value = {
        ...
        demanda_mensal_prod: demandaMensalProd.value,
        ...
        type_item: typeItem.value[typeItem.value.length - 1], // Último item do array
