    ...
    <main class="demo-page-content">
      <section>
        ...
        <!-- <div class="nice-form-group">
          <label>Item</label>
          <input type="text" :placeholder="idPlaceholder" value="" disabled />
        </div> -->
      ...
      <section>
        ...
        <fieldset class="nice-form-group">
          ...
          <br />
          <div class="nice-form-group">
            <label>QTD. Compartilhada</label>
            <input
              v-model.number="qtdCompartilhada"
              type="number"
              placeholder="QTD. Compartilhada"
            />
          </div>
          <div class="nice-form-group">
            <label>QTD. Não Compartilhada</label>
            <input
              v-model.number="qtdNaoCompartilhada"
              type="number"
              placeholder="QTD. Não Compartilhada"
            />
          </div>
  ...
  setup() {
    ...
    const updateItemData = () => {
      requestBody.value = {
        ...
        peso_unit_kg: pesoUnitKg.value,
        custo_unit: custoUnit.value,
        ...
        qtd_compartilhada: qtdCompartilhada.value,
        qtd_naoCompartilhada: qtdNaoCompartilhada.value,
  ...
  mounted() {
    ...
    api
      ...
      .then((response) => {
        ...
        idPlaceholder.value = nextId;
      });

    let boxes = document.querySelectorAll("input[type=checkbox].switch");
    ...
    selects.forEach((s, i) =>
      s.addEventListener("change", () => {
        if (selects[i].value == "Sim") {
          selects[1 - i].value = "Não";
        } else if (selects[i].value == "Não") {
          selects[1 - i].value = "Sim";
        }
      })
    );
