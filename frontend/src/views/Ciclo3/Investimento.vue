    ...
    <div class="content">
      ...
      >
        ...
        <template #empty-message>
          <span style="font-size: 14px; color: #C3cad4">
...
export default {
  ...
  setup() {
    ...
    const btnDeleteItem = (itemObj, key) => {
      ...
      api.delete(`/${currentTable}/C3/deleteItem/` + itemObj.id).then(() => {
        if (key === 1) {
    ...
    const btnEditItem = (itemObj, key) => {
      ...
      if (endpointRoute === "editItem") {
        if (!itemObj.isReadonly && !diffJson) {
          api
            .put(`/${currentTable}/C3/` + endpointRoute, {
              data: itemObj,
            })
            .then(() => {
              notify({
        ...
        if (!itemObj.isReadonly) {
          api
            .post(`/${currentTable}/C3/` + endpointRoute, {
              data: itemObj,
            })
            .then(() => {
              notify({
